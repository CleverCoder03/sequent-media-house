        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-20 gap-8 border-b border-neutral-100 pb-12">
          <div className="max-w-2xl">
            ...
            <h2 className="text-neutral-900 text-5xl md:text-6xl font-figtree-semibold tracking-tight leading-[1.1]">
              Sequencing <span className="font-playfair-semibold-italic italic text-neutral-300">frames</span> into <br />
              Digital <span className="font-playfair-semibold-italic italic text-orange-500">mixtapes</span>.
            </h2>
          </div>
          <div className="flex gap-10">
            <div className="group flex flex-col items-start gap-2">
              <span className="text-[10px] text-neutral-400 uppercase tracking-widest">Technique</span>
            ...
            <div className="group flex flex-col items-start gap-2">
              <span className="text-[10px] text-neutral-400 uppercase tracking-widest">Format</span>
              <div className="flex items-center gap-2 text-neutral-900 text-sm font-figtree-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[300px] md:auto-rows-[250px]">
              ...
              {!isPlaying ? (
                ...
                >
                  ...
                  <div className="absolute bottom-8 left-8">
                    <h3 className="text-3xl text-white font-playfair-semibold-italic italic drop-shadow-md">The Royal Union</h3>
                    <p className="text-orange-500 text-xs uppercase tracking-[0.3em] mt-2 font-figtree-semibold">Jaipur • 2026</p>
                  </div>
                </motion.div>
              ) : (
                <motion.video
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h4 className="text-2xl text-neutral-900 mb-6 font-figtree-semibold">Our <span className="italic font-playfair-semibold-italic">Pulse</span></h4>
            ...
            <ul className="hidden md:block space-y-4 relative z-10">
              {['Atmospheric Audio', 'Candid Sequences', 'Artisanal Grading'].map((item) => (
                <li key={item} className="flex items-center gap-3 text-[10px] text-neutral-900 uppercase tracking-widest font-figtree-medium">
                  <span className="w-1.5 h-1.5 bg-orange-500 rounded-full shadow-[0_0_8px_rgba(249,115,22,0.4)]" /> {item}
                </li>
              ))}
            </ul>
          </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-6 left-6">
               <span className="text-white text-xs uppercase tracking-widest font-figtree-medium">Detail & Grace</span>
            </div>
          </motion.div>
