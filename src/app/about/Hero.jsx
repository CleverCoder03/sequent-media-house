  ...
  return (
    <div className="h-dvh w-full flex justify-center items-center">
      ...
      <div className="relative z-10 lg:w-2/3 pointer-events-none text-center">
        <CharReveal>
          <h1 ref={ref} className="text-neutral-100 text-4xl lg:text-6xl font-montserrat-semibold leading-[1.1] ">
          ...
          <h1 ref={HeroH2Ref} className="text-neutral-100 text-4xl lg:text-6xl font-montserrat-semibold leading-[1.1]">
