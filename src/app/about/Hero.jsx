...
const Hero = forwardRef(({HeroH2Ref, overlayRef}, ref) => {
  return (
    <div className="bg-lime-500 h-dvh w-full flex justify-center items-center">
      {/* Text Content */}
      <div className="relative z-10 lg:w-2/3 pointer-events-none text-center">
        <CharReveal>
          <h1 ref={ref} className="text-neutral-900 text-4xl lg:text-6xl font-montserrat-semibold uppercase leading-[1.1] ">
            Our team is a{" "}
            {/* <MarqueeIcon variant={1} className="mx-5" width={2.5} /> */}
          </h1>
          <h1 ref={HeroH2Ref} className="text-neutral-900 text-4xl lg:text-6xl font-montserrat-semibold uppercase leading-[1.1]">
            creative mixtape{" "}
