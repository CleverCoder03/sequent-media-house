    ...
    <section className="relative h-[95vh] w-full overflow-hidden bg-[#050505] flex items-center justify-center">
      ...
      <div className="relative z-20 container mx-auto px-6 flex flex-col items-center pointer-events-none text-center">
        {/* <motion.span 
          ...
          className="text-lime-theme font-figtree-medium uppercase tracking-[0.4em] text-[10px] md:text-xs mb-8 block"
        >
          Sequencing Eternal Moments
        </motion.span> */}

        <CharReveal>
          <h1 className="text-white text-5xl lg:text-7xl font-figtree-semibold leading-[1.1] tracking-tight">
            Weaving <span className="font-playfair-semibold-italic text-lime-theme italic lowercase">vows</span> into a
          </h1>
          <h1 className="text-white text-5xl lg:text-7xl font-figtree-semibold leading-[1.1] tracking-tight">
            Cinematic <span className="font-playfair-semibold-italic text-lime-theme italic lowercase">rhythm</span> 
          </h1>
        </CharReveal>
        ...
        >
          <p className="text-gray-400 max-w-lg font-figtree-light text-sm md:text-base leading-relaxed tracking-wide">
            ...
            <span className="text-white"> editorial grace</span>. 
            We don&apos;t just film weddings; we sequence your legacy.
          </p>
        </motion.div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20">
        ...
        >
          <span className="text-[9px] uppercase tracking-[0.3em] text-gray-500">Discover</span>
